...
COMMON_FLAGS:=-g -Os -w -ffunction-sections -fdata-sections -nostdlib --param max-inline-insns-single=500 -mcpu=cortex-m3  -mthumb -lSPI
...
MYSRCFILES += $(shell ls $(ADIR)/$(SAM)/libraries/SPI/*.cpp 2>/dev/null) 
